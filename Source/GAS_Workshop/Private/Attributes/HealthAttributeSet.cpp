	...
	if (Data.EvaluatedData.Attribute == GetDamageAttribute())
	{
		...
		if (UAbilitySystemComponent* OwningAbilitySystemComponent = GetValid(GetOwningAbilitySystemComponent()))
		{
			...
			if (OldHealthValue != NewHealthValue)
			{
				...
				// Do not apply damage number if Actor is already Dead
				if (!OwningAbilitySystemComponent->HasAnyMatchingGameplayTags(IASC_Interaction::Execute_GetActorRestrictedTags(OwningAbilitySystemComponent->GetOwner())))
				{
